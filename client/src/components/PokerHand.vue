<template>
  <div
    class="min-h-screen flex flex-col justify-center items-center bg-gradient-to-r from-purple-400 via-pink-500 to-red-500 text-white px-4"
  >
    ...
    <div
      class="bg-white text-gray-900 rounded-lg shadow-lg p-6 sm:p-8 w-full max-w-md sm:max-w-lg text-center my-1"
    >

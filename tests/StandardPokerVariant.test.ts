...
import {StandardPokerVariant} from "../src/variants/StandardPokerVariant";

describe("StandardPokerVariant", () => {
    let pokerVariant: StandardPokerVariant;

    beforeEach(() => {
        pokerVariant = new StandardPokerVariant();
    });
    ...
    test("should evaluate a straight flush", () => {
        ...
        const result = pokerVariant.evaluateHand(hand);
    ...
    test("should throw an error for duplicate cards", () => {
        ...
        expect(() => pokerVariant.evaluateHand(hand)).toThrow("Duplicate cards detected in the hand.");
    });
    ...
    test("should throw an error for incorrect hand size", () => {
        ...
        expect(() => pokerVariant.evaluateHand(hand)).toThrow("A 5-card hand is required.");
    });
});
